...
state("openrct2", "v0.5.5 (8694e34)") {
    byte gScreenFlags : 0x12611b4;
    ulong gScenarioCompletedCompanyValue : 0x1269950, 0x15b8;
    byte _mapChangedExpected : 0x1263ecd;
}

state("openrct2", "v0.5.4 (4a7ee14)") {
    byte gScreenFlags : 0x127be17;
    ulong gScenarioCompletedCompanyValue : 0x12845c0, 0x15b8;
    byte _mapChangedExpected : 0x127e70c;
}

state("openrct2", "v0.5.3 (f503f57)") {
    byte gScreenFlags : 0x1277d27;
    ulong gScenarioCompletedCompanyValue : 0x12805b8, 0x15b8;
    byte _mapChangedExpected : 0x127aabc;
}
...
state("openrct2", "v0.5.1 (90bec9b)") {
    ...
    byte _mapChangedExpected : 0x125b9a8;
}

state("openrct2", "v0.5.0 (075993c)") {
    byte gScreenFlags : 0x12f1257;
    ulong gScenarioCompletedCompanyValue : 0x12f9b10, 0x15b8;
    byte _mapChangedExpected : 0x12f3ffc;
}

state("openrct2", "v0.4.32 (25c7379)") {
    byte gScreenFlags : 0x1270814;
    ulong gScenarioCompletedCompanyValue : 0x1278e70, 0x15b8;
    byte _mapChangedExpected : 0x12733d8;
}

state("openrct2", "v0.4.31 (dae57fc)") {
    byte gScreenFlags : 0x11cd614;
    ulong gScenarioCompletedCompanyValue : 0x11d5ed8, 0x15b8;
    byte _mapChangedExpected : 0x11cfd88;
}

state("openrct2", "v0.4.30 (b0f30a5)") {
    byte gScreenFlags : 0x11b63a5;
    ulong gScenarioCompletedCompanyValue : 0x106d7e8, 0x15b8;
    byte _mapChangedExpected : 0x106d6e9;
}

state("openrct2", "v0.4.29 (ebe87be)") {
    byte gScreenFlags : 0x11a34f5;
    ulong gScenarioCompletedCompanyValue : 0x1052340, 0x15b8;
    byte _mapChangedExpected : 0x1052339;
}

state("openrct2", "v0.4.28 (5847457)") {
    byte gScreenFlags : 0x119f5f5;
    ulong gScenarioCompletedCompanyValue : 0x104e440, 0x15b8;
    byte _mapChangedExpected : 0x104e439;
}

state("openrct2", "v0.4.27 (dbb9fd9)") {
    byte gScreenFlags : 0x11895c5;
    ulong gScenarioCompletedCompanyValue : 0x1038410, 0x15b8;
    byte _mapChangedExpected : 0x1038409;
}

state("openrct2", "v0.4.26 (84fc3bc)") {
    byte gScreenFlags : 0x1154445;
    ulong gScenarioCompletedCompanyValue : 0x1003290, 0x15b8;
    byte _mapChangedExpected : 0x1003289;
}

state("openrct2", "v0.4.25 (de986f5)") {
    byte gScreenFlags : 0x10d6ad5;
    ulong gScenarioCompletedCompanyValue : 0xf85930, 0xe00;
    byte _mapChangedExpected : 0xf85919;
}

state("openrct2", "v0.4.24 (8592e6b)") {
    byte gScreenFlags : 0x10d49d5;
    ulong gScenarioCompletedCompanyValue : 0xf83830, 0xe00;
    byte _mapChangedExpected : 0xf83819;
}

state("openrct2", "v0.4.23 (b8d73b5)") {
    byte gScreenFlags : 0x10cbd05;
    ulong gScenarioCompletedCompanyValue : 0xf7ab90, 0xe00;
    byte _mapChangedExpected : 0xf7ab79;
}

state("openrct2", "v0.4.22 (b7199e3)") {
    byte gScreenFlags : 0x10b6c85;
    ulong gScenarioCompletedCompanyValue : 0xf65b20, 0xe00;
    byte _mapChangedExpected : 0xf65b09;
}
...
init {
    ...
    switch (hash) {
        case "5ea4e5e25e27189c542e5b450f590e755e1c060574f9e874d0c7c1358c7398ec":
            version = "v0.5.5 (8694e34)";
            vars.loadRemover = true;
            break;
        case "7c80787a21fea94e2d911f2f00f2f0c6864cf0c20e70a8c61c939d1b34ff7b55":
            version = "v0.5.4 (4a7ee14)";
            vars.loadRemover = true;
            break;
        case "ea8a62bb3cb7cd3f96fa6538c6f641bcddf725dd144ed20966793f6665030cc3":
            version = "v0.5.3 (f503f57)";
            vars.loadRemover = true;
            break;
        ...
        case "f1513e7bfd36d243d72ab490da50c8551fc79a724b33dc3bfa61bbb6d6b52e69":
            ...
            vars.loadRemover = true;
            break;
        case "7cbfe636feae2a46f463a87d998869fad62246a56537215b456dd186e6867129":
            version = "v0.5.0 (075993c)";
            vars.loadRemover = true;
            break;
        case "ae75be9b19b2ca12c24dfa042c2c2cd3540a7da727a4a408d10f26fad56ef955":
            version = "v0.4.32 (25c7379)";
            vars.loadRemover = true;
            break;
        case "43b1b3bd3077ee2c8859310244feb0806ae3d936f310ebe1b5352bb5aa9e0aa8":
            version = "v0.4.31 (dae57fc)";
            vars.loadRemover = true;
            break;
        case "e2652b4edbbac6765ac15df571b347688faf2a0100f5c9355c4886a2c92d0ec6":
            version = "v0.4.30 (b0f30a5)";
            vars.loadRemover = true;
            break;
        case "ff26fd46d2761c8db5fcfb867534f43e08d2d6ea9c6f96d427cc71a770d4b32c":
            version = "v0.4.29 (ebe87be)";
            vars.loadRemover = true;
            break;
        case "912184c9dfa6bd81ac7e0a999d6fe02c2dd27e6ad837890a6017e37a6f8070b4":
            version = "v0.4.28 (5847457)";
            vars.loadRemover = true;
            break;
        case "32ba89d6703a1fafd15d98c614adb5c527e3789237ff354e7c6dcccf22a1d236":
            version = "v0.4.27 (dbb9fd9)";
            vars.loadRemover = true;
            break;
        case "e5ec4bba007ee108ce744e5a87f514b2573f0d4016fc8c7683a3902d6e236590":
            version = "v0.4.26 (84fc3bc)";
            vars.loadRemover = true;
            break;
        case "d8c1224d71be747a17c07cc025a9c570af9829d4f4d6d5dbf3c34d4f70963815":
            version = "v0.4.25 (de986f5)";
            vars.loadRemover = true;
            break;
        case "20a5dc1184214195f684b59dce99fb5e9ddfd8c12fea5f86aba1b7bbbe7ef7c2":
            version = "v0.4.24 (8592e6b)";
            vars.loadRemover = true;
            break;
        case "41eb18b7de64c6c27cd8483c8f57d1000c8213e60dedb11ae26e498bad758055":
            version = "v0.4.23 (b8d73b5)";
            vars.loadRemover = true;
            break;
        case "11adb02f1ca6cb3f53294da2d50eb9dd235f7b2b884f2ded0ebb59d1dea64272":
            version = "v0.4.22 (b7199e3)";
            vars.loadRemover = true;
            break;
